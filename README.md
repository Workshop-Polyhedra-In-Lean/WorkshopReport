...
## Usage
To add your part of the report, make a new file shaped like `section_template.tex`, put your content, and insert a new line `\include{my_section.tex}` at the appropriate place in `main.tex`.
